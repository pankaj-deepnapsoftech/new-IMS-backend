...
const { create, unapproved, update, autoBom, remove, details, all, findFinishedGoodBom, unapprovedRawMaterials, approveRawMaterial, approveRawMaterialForAdmin, unapprovedRawMaterialsForAdmin, bomsGroupedByWeekDay, getInventoryShortages } = require('../controllers/bom');
